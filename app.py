...
# postgresql://postgres.oifnmsouiljriagbdzhz:[YOUR-PASSWORD]@aws-1-us-east-2.pooler.supabase.com:5432/postgres
import psycopg2
# Fetch variables
USER = "postgres.oifnmsouiljriagbdzhz" #os.getenv("user")
PASSWORD = "USIL2025cc25"# os.getenv("password")
